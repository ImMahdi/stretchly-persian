# Graph Report - Stretchly  (2026-09-08)

## Corpus Check
- 130 files · ~165,614 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 720 nodes · 1004 edges · 96 communities (87 shown, 9 thin omitted)
...
### Community 0 - "main.js"
Cohesion: 0.07
Nodes (65): breakComplete(), calculateBackgroundColor(), checkVersion(), closeWindows(), commandLineArguments, createContributorSettingsWindow(), createPreferencesWindow(), createSyncPreferencesWindow() (+57 more)

### Community 1 - "build"
Cohesion: 0.18
Nodes (11): build, appId, dmg, portable, productName, snap, contents, icon (+3 more)
...
Cohesion: 0.12
Nodes (10): versionChecker, applyBreakHealthEffect(), dangerColorForTheme(), dangerColors, defaultDangerColor, HtmlTranslate, createRunOnce(), maxWidth() (+2 more)

### Community 4 - "DndManager"
Cohesion: 0.08
Nodes (5): AppExclusionsManager, DndManager, desktopIdle, NaturalBreaksManager, Scheduler
...
Cohesion: 0.05
Nodes (37): [0.11.0] - 2017-09-09, [0.13.0] - 2017-12-20, [0.1.0] - 2016-09-26, [0.1.1] - 2016-10-04, [0.2.0] - 2016-10-08, [0.2.1] - 2016-10-10, [0.3.0] - 2016-10-15, [1.13.0] - 2022-12-23 (+29 more)
...
### Community 16 - "target"
Cohesion: 0.22
Nodes (9): win, asarUnpack, target, 7z, appx, node_modules/macos-notification-state/**, node_modules/windows-notification-state/**, nsis (+1 more)
...
## Knowledge Gaps
- **331 isolated node(s):** `__filename`, `__dirname`, `global`, `commandLineArguments`, `gotTheLock` (+326 more)
